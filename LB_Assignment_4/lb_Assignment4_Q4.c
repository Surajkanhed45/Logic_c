//Write a program which is accept a number from user and print non factor of addition of that number
/*
START
	get DisplayFactor method do display Even factor only of any number that is accepted by user
		...
		In our method gives some condition
			...
			and printed Numbers(i) becomes a non factor of value(variable) 
				and get the addition of that number which is non factor of given number
END
*/
/*Enter any number:12
 5 7 8 9 10 11
